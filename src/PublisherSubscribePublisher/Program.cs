...
public class Program
{
    ...
    private static void CreateConnection()
    {
        ...
        _model.ExchangeDeclare(exchange: ExchangeName, type: ExchangeType.Fanout, false,false);
    }
    
    private static void SendMessage(Payment message)
    {           
        _model.BasicPublish(exchange:ExchangeName, string.Empty, null, message.Serialize());
